  ...
  return (
    <motion.div
      ...
      className={[
        ...
        decided ? 'shadow-glow-win' : ready ? 'shadow-glass hover:shadow-glow-accent' : 'shadow-glass',
      ].join(' ')}
    >
      <TeamRow team={match.teamA} isWinner={aWins} isLoser={decided && !aWins && Boolean(match.teamA)} onSelect={onSelectA} />
      ...
      <TeamRow team={match.teamB} isWinner={bWins} isLoser={decided && !bWins && Boolean(match.teamB)} onSelect={onSelectB} />
    </motion.div>
  );
}
